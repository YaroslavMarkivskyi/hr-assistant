...
class ServiceContainer:
    ...
    def create(cls, config: Config) -> 'ServiceContainer':
        ...
        container._initialize_modules()
        return container
        
    def _initialize_modules(self):
        """
        Initialize feature-specific modules and add them to the container.
        """
        logger.info("Initializing feature-specific modules...")
        
        from features.time_off.module import TimeOffModule
        from features.scheduling.module import SchedulingModule
        
        try:
            self.features[BotModule.TIME_OFF] = TimeOffModule.setup(self)
            self.features[BotModule.SCHEDULING] = SchedulingModule.setup(self)
