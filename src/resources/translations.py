...
TRANSLATIONS: Dict[Language, Dict[str, str]] = {
    Language.ENGLISH: {
        ...
        "message.module_in_development": "{module} module is under development",
        "message.feature_in_development": "This feature is under development",
        ...
        "message.unhandled_request": "Sorry, I cannot process your request at this time.",
        ...
        "time_off.request_already_processed": "This request has already been processed.",
    ...
    Language.UKRAINIAN: {
        ...
        "message.module_in_development": "Модуль {module} в розробці",
        "message.feature_in_development": "Ця функція в розробці",
        ...
        "message.unhandled_request": "Вибачте, я не можу обробити ваш запит на даний момент.",
        ...
        "time_off.request_already_processed": "Ця заявка вже оброблена.",
